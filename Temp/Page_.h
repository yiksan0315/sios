...
typedef struct kPageTableEntryStruct
{
    ...
    // 11 비트 Base Address
    uint dwAttributeAndLowerBaseAddress;
    // 8 비트 Upper BaseAddress, 12 비트 Reserved, 11 비트 Avail, 1 비트 EXB 
    uint dwUpperBaseAddressAndEXB;
...
void kSetPageEntryData( PTENTRY* pstEntry, uint dwUpperBaseAddress,
        uint dwLowerBaseAddress, uint dwLowerFlags, uint dwUpperFlags );
